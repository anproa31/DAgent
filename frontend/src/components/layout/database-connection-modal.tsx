...
export function DatabaseConnectionModal({
  ...
  const handleClose = (open: boolean) => {
    if (!open) {
      // If the modal is closed after success, invalidate the cache
      if (step === 'success') {
        invalidateQueries()
      }
      resetModal()
          ...
          {step === 'success' && (
            ...
            >
              <div className='space-y-4'>
                ...
                {/* <p className="text-sm text-muted-foreground">The table list in the sidebar will be updated</p> */}
                {successMessage && (
              ...
              <div className='mx-auto max-w-md'>
                {/* <h4 className="text-sm font-medium text-muted-foreground mb-3">Loaded tables:</h4> */}
