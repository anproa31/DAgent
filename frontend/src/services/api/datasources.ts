...
export const listDatasources = async (): Promise<DatasourceRecord[]> => {
  const res = await serverClient.get<DatasourceListResponse>('/api/datasources')
...
export const uploadDatasourceFiles = async (
  ...
  const res = await serverClient.post<CreateFileDatasourceResponse>(
...
export const connectDatabaseDatasource = async (
  ...
  const res = await serverClient.post<DatasourceRecord>(
    '/api/datasources/connect',
    payload
  )
  return res.data
}
...
export const deleteDatasource = async (
  ...
  const res = await serverClient.delete<DeleteDatasourceResponse>(
